...
contract Film is IFilm, Ownable{
    ...
    function setBooking(string calldata cinema, string calldata room, string calldata position, uint256 timestamp) public override returns (bool){
